...
class ClientServiceBase {
   ...
   * @param {LedgerPrivileged} ledgerPrivileged LedgerPrivileged object to inject
   * @param {Protobuf} protobuf protobuf object to inject
   * @param {Object} properties JSON Object used for setting client properties
   */
  // TODO create new parameter for for privilege service
  // TODO proofregistry service
  constructor(
      ledgerClient, ledgerPrivileged, proofRegistry, protobuf, properties) {
    /** @const */
    ...
    /**
     * The ProofRegistry generated by gRPC library
     * @constant
     */
