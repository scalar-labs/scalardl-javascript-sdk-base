...
class ClientServiceBase {
   ...
   */
  constructor(service, protobuf, properties) {
    /** @const */
     ...
     * @constant
     */
    this.ledgerClient = this.getRequiredProperty_(service, 'ledgerClient');

    /**
     * The LedgerPrivileged generated by gRPC library
     * @constant
     */
    this.ledgerPrivileged = this.getRequiredProperty_(service,
        'ledgerPrivileged');
